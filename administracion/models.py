...
def inmueble_path(instance, file_name):
    print('ID', instance.pk) #//El id o pk en este punto es None
    return '{}/{}/{}'.format(
        instance.Propiedades.id,
        instance.pk,
        file_name)



class ImagenesPropiedades(models.Model):
    #imagen = models.ImageField(upload_to='propiedades/')
    imagen = models.ImageField(upload_to=inmueble_path, blank=True,
                                null=True, max_length=99)
    propiedadimg = models.ForeignKey('Propiedades', models.DO_NOTHING, db_column='propiedadImg')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'imagenes_propiedades'

    def __str__(self):
            return self.propiedadimg, self.imagen
...
class Propiedades(models.Model):
    ...
    reservado = models.IntegerField(False)
